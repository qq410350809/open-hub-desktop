...
use crate::models::{Database, RequestHealthBucket, RequestHealthReport, TokenStatsReport, TokenUsageBucket, TokenUsageReport};
...
use std::time::UNIX_EPOCH;
    ...
    fn reads_catpawai_usage_and_resolves_numeric_model_ids() {
        ...
        assert_eq!(bucket.input_tokens, 1000, "fresh input should be prompt - cached");
    ...
    fn catpawai_parses_gateway_format_with_separate_cache_read() {
        ...
        assert_eq!(bucket.total_tokens, 11473, "total should include fresh + cache + output");
    ...
    fn catpawai_deduplicates_repeated_usage_rows() {
        ...
        assert_eq!(bucket.cached_input_tokens, 2000, "should keep the larger cache_read");
