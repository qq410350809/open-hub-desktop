...
pub async fn rotate_account_instance_node(
    ...
    let _ = crate::proxy_pool::runtime::ensure_account_instance(database, runtime, profile_id);
    Ok(next_id)
}
...
pub fn proxy_url_for_account(
    ...
    let port = crate::proxy_pool::runtime::ensure_account_instance(&database, &runtime, profile_id)?;
    ...
    Fut: std::future::Future<Output = Result<T, String>>,
{
    ...
    let account_port = crate::proxy_pool::runtime::ensure_account_instance(&database, &runtime, profile_id)?;
